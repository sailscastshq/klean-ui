...
>
  <figcaption data-slot="line-chart-caption" class="col-span-2 text-sm font-semibold">
    {caption}
  </figcaption>
  ...
  {#if hasValues}
    <div
      ...
      class={twMerge(
        ...
        chart.minimum === chart.maximum ? "place-items-center" : "content-between",
      )}
    >
  ...
  {#if hasValues}
    ...
    >
      ...
      >
        <g data-slot="line-chart-guides" class="text-gray-200 dark:text-gray-800">
