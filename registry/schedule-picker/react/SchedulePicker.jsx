  ...
  return (
    ...
    >
      ...
      <p
        ...
        className="text-sm text-gray-600 aria-[invalid=true]:text-red-700 dark:text-gray-400 dark:aria-[invalid=true]:text-red-400"
              ...
              >
                {choices.map((time, index) => (
                  <button
                    ...
                    className="block min-h-11 w-full rounded-md px-3 text-start text-sm tabular-nums hover:bg-gray-100 focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-gray-950 disabled:cursor-not-allowed disabled:text-gray-300 aria-selected:bg-gray-950 aria-selected:font-semibold aria-selected:text-white dark:hover:bg-gray-800 dark:focus-visible:outline-white dark:disabled:text-gray-700 dark:aria-selected:bg-white dark:aria-selected:text-gray-950"
