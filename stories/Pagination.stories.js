    ...
    template: `
      <section class="klean-story-canvas px-5 py-14 sm:px-8 lg:px-12 lg:py-20" aria-labelledby="pagination-states-title">
        <header class="max-w-3xl">
          <h1 id="pagination-states-title" class="text-balance text-4xl font-semibold tracking-tighter sm:text-5xl">Edges tell the truth.</h1>
  ...
  render: () => ({
    ...
    template: `
      <section class="klean-story-canvas px-5 py-14 sm:px-8 lg:px-12 lg:py-20" aria-labelledby="pagination-apps-title">
        <header class="max-w-3xl">
          <h1 id="pagination-apps-title" class="text-balance text-4xl font-semibold tracking-tighter sm:text-5xl">Same navigation. Product-owned finish.</h1>
