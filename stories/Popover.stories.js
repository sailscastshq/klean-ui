          ...
          <div>
            ...
            >
              <section class="flex flex-col gap-1" aria-label="Share invoice">
                <button type="button" aria-label="Send via email" class="group flex w-full cursor-pointer items-center gap-3 rounded-[1rem] px-3 py-2.5 text-left text-sm font-medium text-black transition-colors hover:bg-black/5">
                ...
                <button type="button" aria-label="Copy link" class="group flex w-full cursor-pointer items-center gap-3 rounded-[1rem] px-3 py-2.5 text-left text-sm font-medium text-black transition-colors hover:bg-black/5">
                  <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-black/5 text-black/70 transition-colors group-hover:bg-black/10">
                    <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                ...
                <button type="button" aria-label="Generate PDF" class="group flex w-full cursor-pointer items-center gap-3 rounded-[1rem] px-3 py-2.5 text-left text-sm font-medium text-black transition-colors hover:bg-black/5">
