...
explicit confirmation step without a provider or configuration file.
...
or **Use this time** commits the proposal, while the named form value retains
the last confirmed ISO instant through incomplete or ambiguous drafts.
